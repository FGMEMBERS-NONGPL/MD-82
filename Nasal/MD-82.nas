...
#
var engine_dialog = gui.Dialog.new("Aircraft/MD-82/Systems/announcements-dialog.xml");

aircraft.livery.init("Aircraft/MD-82/Models/Liveries");
...
setlistener("/sim/signals/fdm-initialized", func {
								# Start the fuel system. The MD-82 uses a customized
								# fuel routine to avoid the default cross-feed situation.
  FuelInit();							# See MD-82_fuel.nas
								# Start the custom flight surface system. The MD-82 uses
								# this to handle spoiler operations and tabbed control
								# surface simulation.
  FlightSurfaceInit();						# See MD-82_flightsurfaces.nas
  PneumaticsInit();						# See MD-82_pneumatics.nas
  InstrumentationInit();					# See MD-82_instrumentation_drivers.nas
  MD81_Savedata();
});
